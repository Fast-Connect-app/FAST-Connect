...
abstract class AbstractButton<P extends AbstractButtonProps = AbstractButtonProps,S extends AbstractButtonState=AbstractButtonState > extends Component<P, S> {
  constructor(props: P) {
    super(props);
    this.state = {
      isClicked: false,
